        ...
        return {
            ...
            link: function postLink(scope, element, attrs) {
                ...
                var downloadHTMLBundle = function() {
                    ...
                    var fetchChartSpecifications = function() {
                        ...
                        return JSON.parse('{ "title": "' + scope.chart.title() + '" ,' + specifications + ' }');
                    }

                    var configObject = {};
                    configObject.data = scope.data;
                ...
                scope.modes = [{
                    ...
                    {
                        label: 'HTML bundle (zip)',
                        download: downloadHTMLBundle
                    }
                ]
            }
        };
