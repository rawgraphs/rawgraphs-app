...
<head>
  ...
  <meta property="og:image" content="http://app.rawgraphs.io/imgs/cover-for-socials.jpg">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">
  <meta property="og:url" content="http://app.rawgraphs.io/">
...
<body data-spy="scroll" data-target="#raw-nav">
  ...
  <header class="navbar navbar-static-top" role="navigation" id="raw-nav" role="banner">
    <div class="container">
     <div class="navbar-header">
        ...
        <a class="navbar-brand" href="http://rawgraphs.io/" target="_blank">
          <img alt="RawGraphs" src="imgs/rawgraphslogo.png">
        </a>
      </div>

      <nav class="collapse navbar-collapse" role="navigation" id="raw-navbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="http://rawgraphs.io/about/" target="_blank">About</a></li>
          <li><a href="http://rawgraphs.io/gallery/" target="_blank">Gallery</a></li>
          <li><a href="http://rawgraphs.io/learning/" target="_blank">Learning</a></li>
          <li><a href="https://github.com/densitydesign/raw/wiki/FAQs" target="_blank">FAQs</a></li>
          <li><a href="https://docs.google.com/forms/d/e/1FAIpQLSdfbS0TsyQEXdNfYp9XkiDx5pzwEYfKCmplDJTz1VPAm1R6VA/viewform" target="_blank">User survey</a></li>
          <li><a href="https://github.com/densitydesign/raw/wiki/Developer-Guide" target="_blank">Developer Guide</a></li>
          <li><a href="https://github.com/densitydesign/raw" target="_blank" style="font-size:23px"><i class="fa fa-github"></i></a></li>
        </ul>
      </nav>
  ...
  <div id="footer">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <p><strong>RAW</strong> is an open source project by <a href="http://www.densitydesign.org">DensityDesign Lab</a> and <a href="http://calib.ro">Calibro</a></p>
          <p><a href="https://www.giorgiocaviglia.com" target="_blank">Giorgio Caviglia,</a> <a href="http://www.densitydesign.org/person/michele-mauri/" target="_blank">Michele Mauri</a>, <a href="http://calib.ro" target="_blank">Giorgio Uboldi</a>, <a href="http://calib.ro" target="_blank">Matteo Azzi</a></p>
          <p>&copy; 2013-2017 (<a href="https://raw.github.com/densitydesign/raw/master/LICENSE">Apache License 2.0</a>)</p>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
          <p><a href="mailto:hello@rawgraphs.io"><i class="fa fa-envelope breath-right"></i>hello@rawgraphs.io</a></p>
          <p><a href="http://twitter.com/rawgraphs"><i class="fa fa-twitter breath-right"></i>rawgraphs</a></p>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
