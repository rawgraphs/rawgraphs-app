...
raw.charts.bubblechart = function(){
	...
	return {
		...
		description : "The bubble chart uses Cartesian coordinates to represent three numerical variables using circles position and area. Useful to spot out correlations between variables.",
