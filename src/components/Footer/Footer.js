  ...
  return (
    <Container className={styles.footer} fluid>
        <Row>
          ...
          <Col xs={3}><p className="small">This <span title={commitHash}>version</span> is intended to be available only for the backers of the crowdfunding campaign.</p></Col>
